...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
    <a href="./Home.php" class="navbar-brand"><i class="fa fa-cube"></i>FALL IN<b> LUV</b></a>
...
<section class="jumbotron text-center">
            <div class="container">
                <h1 class="text black" class="jumbotron-heading">Fall in luv</h1>
                <p class="lead text-muted mb-0">Thực phẩm sạch, chất lượng và an toàn</p>
            </div>
</section> 
</body>                           